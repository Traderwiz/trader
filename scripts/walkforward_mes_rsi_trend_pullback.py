"""Run rolling walk-forward validation for MES RSI trend pullback."""
...
def main() -> None:
    ...
    print("MES RSI Trend Pullback Walk-Forward")
    for test_year in range(2003, latest.year + 1):
        ...
        test_result = run_backtest_with_backfill(dt(test_start_day), dt(test_end_day, end_of_day=True))
