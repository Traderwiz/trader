"""MES RSI(2) trend-pullback strategy implementation."""
...
class MESRSITrendPullbackStrategy(Strategy):
    """Long-only daily MES trend pullback filtered to trending regimes."""
    ...
    version = "1.0.0"
    strategy_name = "mes_rsi_trend_pullback"

    def __init__(self) -> None:
        super().__init__()
        self.sma_100: SMA | None = None
    ...
    def on_bar(self, bar: BarEvent) -> None:
        ...
        sma_value = self._require_indicator(self.sma_100).update(bar)
